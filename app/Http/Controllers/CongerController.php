    ...
    public function validation_conges(){
        ...
        if(Auth::user()->hasRole('Chef_de_projet')){
            $conges = DB::table('absconges')
                ...
                ->where([['absconges.etat','=',1],['personne.id_entite','=',Auth::user()->id_chantier_connecte],['roles.name','=','Chef_de_service']])
                ->orwhere([['contrat.id_service','=',Auth::user()->id_service],['absconges.etat','=',1],['personne.id_entite','=',Auth::user()->id_chantier_connecte]])
