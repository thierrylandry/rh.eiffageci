                ...
                <table class="table table-borderles" id="table_employe">
                    ...
                    <tbody>
                            @foreach($avantages as $avantage)
                                ...
                                <td> <a class="btn btn-primary retourner" href="#" data-toggle="modal" data-target="#smallmodal"><i class="fas fa-history"></i> Retourner</a><a onclick="" class="btn btn-danger" href="{{route('supprimer_avantage',['id'=>$avantage->id])}}"><i class="fas fa-trash"></i></a></td>
                                </tr>
                                @endforeach
                    </tbody>
                </table>
