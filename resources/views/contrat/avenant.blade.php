...
@section('content')
    ...
    @foreach($array_intersection as $modif)
        ...
        @break
        @case("La catégorie")
        <p>- <b class="classtext"> {{$modif}} {{isset($contratprec->id_categorie)?$contratprec->id_categorie:''}} (({{isset($contratprec->definition)?$contratprec->definition->libelle:''}})) devient {{isset($contrat->id_categorie)?$contrat->id_categorie:''}} (({{isset($contrat->definition)?$contrat->definition->libelle:''}})) </b> </p>
        @break
        @case("Le budget mensuel")
        <p>- <b class="classtext"> Salaire</b> </p>
        @break
        @default
