    ...
    <div class="row">
        <div class="col-md-12">
            <div class="overview-wrap">
                <h2 class="title-1">TABLEAU DE BORD DE LA DIRECTION CI</h2><a href="javascript:window.print()" id="btnprint"  class="btn btn-info"><i class="fa fa-print"></i> Imprimer</a>
            </div>
                ...
                <div class="card-body" >
                    <div class="table-responsive table-responsive-data2">
                        <table class="table  table-earning" id="table_employe">
                            <thead>
                            <tr>
                                <th style="min-width: 400px; max-width: 400px">Répartition tranche d'age DIRECTION CI</th>
                                <th>EFFECTIF</th>
                            </tr>
                            </thead>
                            <tbody>
